A library for finite state machine realization.A library for Dart developers. Inspired by [Tinder StateMachine library](https://github.com/Tinder/StateMachine).
